...
if set_dir == main_dataset:
    ...
    xlsx_path = 'data/risk_factor.xlsx'
elif set_dir == set1_147:
    dataset = dataset + '_set1_147'
    xlsx_path = 'data/set1.xlsx'
    ...
    with open('isolate_test/cls_metrics/metrics_' + model_name + '_' + dataset + '_isolate.txt', "w+") as f:
        for ep in test_epoch:
            ...
            with torch.no_grad():
                ...
                ACC_low, ACC_high, SEN_low, SEN_high, SPEC_low, SPEC_high, F1_SCORE_low, F1_SCORE_high, AUC_low, AUC_high = my_bootstrap_ci_model(
